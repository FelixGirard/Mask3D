...
class iModelPreprocessing(BasePreprocessing):
    def __init__(
        self,
        data_dir: str = "../../data/raw/imodel",
        save_dir: str = "../../data/processed/imodel",
    ...
    def compute_color_mean_std(
        self,
        train_database_path: str = "./data/processed/imodel/train_database.yaml",
    ):
